...
# ==========================================
# 2. PROPERLY REPAIR CORRUPTED TRANSLATIONS
# ==========================================

# Your uploaded dataset contains UTF-8 text
# incorrectly decoded into Windows characters.
# This function repairs that text.
...
for number in range(256):
    ...
    try:
        ...
        character = bytes([number]).decode("cp1252")

        cp1252_map[character] = number
...
def repair_encoding(text):
    ...
    for _ in range(4):
        ...
        for character in text:
            ...
            if character in cp1252_map:

                byte_data.append(
                    cp1252_map[character]
                )
...
marathi = pd.DataFrame({

    "text": df["text_mr"].apply(
        repair_encoding
    ),
